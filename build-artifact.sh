...
SOURCE_FILES=(
    ...
    "src/db/state/tables/table.flow.job.sql"
    "src/db/state/tables/table.flow.job_step.sql"
    "src/db/state/tables/table.flow.job_execution_log.sql"
    ...
    "src/db/state/functions/function.flow.create_job.sql"
    "src/db/state/functions/function.flow.add_pipeline_to_job.sql"
    "src/db/state/functions/function.flow.remove_pipeline_from_job.sql"
    "src/db/state/functions/function.flow.list_jobs.sql"
    "src/db/state/functions/function.flow.list_job_steps.sql"
    "src/db/state/functions/function.flow.run_job.sql"
